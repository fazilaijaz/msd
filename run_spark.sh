...
spark-submit --conf spark.yarn.executor.memoryOverhead=4096 --executor-memory 4G --driver-memory 4G --executor-cores 4 --driver-cores 4 --conf spark.default.parallelism=12 spark_app.py
